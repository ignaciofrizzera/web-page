...
export const SPOTIFY_ETL_DATA = {
    ...
    projectOverview: "Basic ETL developed in Python, using Spotify's API with the Spotipy package. The data is collected three times a day: 9:30AM, 5:30PM and 11:30PM (UTC-3). The ETL runs on AWS services such as Step-Functions, Lambda Functions, and S3.",
